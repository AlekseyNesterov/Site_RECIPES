    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steps_cook', models.TextField(verbose_name='Шаги')),
                ...
                ('author_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='blog_app.author', verbose_name='Автор')),
                ('category_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='blog_app.category', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipe_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog_app.recipe')),
            ],
        ),
    ]
